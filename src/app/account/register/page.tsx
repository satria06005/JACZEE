      ...
      <div className="w-full max-w-6xl mx-auto px-6 pt-32 pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative w-full h-[600px] lg:h-[800px] bg-stone-100 hidden md:block overflow-hidden group">
            <Image 
              src="https://picsum.photos/seed/account-register/800/1000"
              alt="Model Fashion Register"
              fill
            ...
            <div className="absolute bottom-10 left-10 text-white">
              <h2 className="text-2xl font-light tracking-[0.2em] uppercase mb-2">Jadilah Bagian</h2>
