...
export default function LoginForm({ bannerImageUrl, bannerTitle }: LoginFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (result.success) {
      ...
      addToast(result.error || "Gagal masuk.", "error");
    }
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col justify-center px-4 md:px-10 lg:px-0">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              >
                <span className="relative z-10">{isPending ? "MEMPROSES..." : "LANJUTKAN"}</span>
