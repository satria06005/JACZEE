...
export default async function AboutPage() {
  ...
  const aboutHero = getBanner('about_hero', {
    title: "Tentang Kami",
    imageUrl: "https://picsum.photos/seed/jaczee-about/1920/1080",
  });

  const aboutPhilosophy = getBanner('about_philosophy', {
    imageUrl: "https://picsum.photos/seed/jaczee-philosophy/800/1000",
  });

  const aboutCraft = getBanner('about_craft', {
    imageUrl: "https://picsum.photos/seed/jaczee-craft/800/1000",
  });
    ...
    <div className="min-h-screen bg-white text-black">
      ...
      <div className="relative w-full h-[70vh] md:h-screen bg-stone-100">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-6 text-center">
          <FadeIn direction="up">
            <h1 className="text-4xl md:text-6xl font-bold tracking-[0.3em] uppercase mb-6">{aboutHero.title}</h1>
