  ...
  return (
    <div className="min-h-screen bg-white text-black">
      ...
      <div className="relative w-full h-[300px] md:h-[400px] mb-16 overflow-hidden bg-stone-900 group">
        <Image 
          src="https://picsum.photos/seed/mens-banner/1600/600"
          alt="Koleksi Pria"
          fill
          className="object-cover opacity-70 group-hover:scale-105 transition-transform duration-1000"
        />
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-6">
          <h2 className="text-3xl md:text-5xl font-light tracking-widest uppercase mb-4">Gaya Pria Modern</h2>
      ...
      {products.length > 0 ? (
        <ProductGrid title="Koleksi Pria" products={products} />
      ) : (
